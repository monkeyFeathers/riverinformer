        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "a",
                { href: "#clackamas", className: "river-selector", "data-river-name": "clackamas", onClick: this.handleClick.bind(this, 'clackamas') },
                "Clackamas"
              )
            ),
            React.createElement(
              ...
              React.createElement(
                "a",
                { href: "#sandy", className: "river-selector", "data-river-name": "sandy", onClick: this.handleClick.bind(this, 'sandy') },
                "Sandy"
              )
            )
          )
