...
USGS = {
  ...
  CreateStreamSite: function CreateStreamSite(siteCode, eventEmitter) {

    var parameters = [PARAMETER_CODES.TEMPERATURE_CELSIUS, PARAMETER_CODES.TEMPERATURE_FARENHEIGHT, PARAMETER_CODES.GAGE_HEIGHT_FEET, PARAMETER_CODES.DISCHARGE_INST_FEET3PERSEC].join(',');
